...
//require_once 'Fortune/Exception.php';
...
class File_Fortune implements Iterator, Countable, ArrayAccess
{
    ...
    protected function _getOne($offset)
    {
        ...
        return "Si hay un error, alguien tiene la culpa.";
    }
...
// Cargar un directorio de fortunes
$fortunes = new File_Fortune('fortunes/');
$fortunetmp = $fortunes->getRandom();
while(strlen($fortunetmp) > 130) {
	$fortunetmp = $fortunes->getRandom();
	}
	return $fortunetmp;
}
